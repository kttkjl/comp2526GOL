...
public class Herbivore extends Entity {
    ...
    /**
     * Selects a Cell from 2 lists: priority, and non-priority. Selects priority
     * Cells if array not null
     * 
     * @param pCells
     ...
     * @return
     */
    private Cell selectPriority(Cell[] pCells, int pInd, Cell[] otherCells, int oInd) {
        Cell priority = null;
        if (pInd > 0) {
